...
namespace Evrinoma\PartnerBundle\Facade\Partner;

use Evrinoma\PartnerBundle\Manager\CommandManagerInterface;
use Evrinoma\PartnerBundle\Manager\QueryManagerInterface;
use Evrinoma\PartnerBundle\PreValidator\DtoPreValidatorInterface;
